...
* **Q#04**:
  ...
  * Test your constants in your REPL session:
    ...
    Main> elem X _EMPTY_ROW_
    False
    Main> elem O _EMPTY_ROW_
    False
    Main> all (== _EMPTY_ROW_) _EMPTY_BOARD_
    True
    ```
...
* **Q#05**:
  ...
  * Test `isTied` in your REPL session:
    ...
    Main> isTied _EMPTY_BOARD_
    False
    Main> isTied _TIED_BOARD_
    True
    ```
